	...
	*/
	...
	switchCapabilityListener(capabilityId, value) {
		...
		if (capabilityId === "onoff.1") {
			if (value === true) {
				this.log('[AqaraLightControlDouble] [switchCapabilityListener] Triggering ctrl_ln2.aq1_switch2_turned_on');
				this._triggerSwitchTwoOn.trigger(this, {}, {});
			}
			else {
				this.log('[AqaraLightControlDouble] [switchCapabilityListener] Triggering ctrl_ln2.aq1_switch2_turned_off');
