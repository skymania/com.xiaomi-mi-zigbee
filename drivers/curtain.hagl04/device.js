	...
	onMeshInit() {
		...
		if (this.hasCapability('windowcoverings_set')) {
			this.registerCapability('windowcoverings_set', 'closuresWindowCovering')/* , {
				set: 'presentValue',
				setParser(value) {
					this.log('windowcoverings_set', value);
					return {data: commandMap[value].command, };
				},
				get: 'presentValue',
				report: 'presentValue',
				reportParser(value) {
					this.log('windowcoverings_report', value)
					return value / 100;
				},
				endpoint: 0,
				getOpts: {
...
0xff27		= boolean = false = clear postition
0xff28 = reverse

0xff29 = manual open	true = disabled, false = enabled
