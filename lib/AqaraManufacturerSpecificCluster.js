...
const AQARA_ATTRIBUTES = {
  ...
  103: { name: 'state3' }, // type: ZCLDataTypes.uint16
...
const ATTRIBUTES = {
  ...
  aqaraMotionRetriggerInterval : {
    id: 258, //0x0102
    type : ZCLDataTypes.uint8, // Aqara P1 motion sensor motion retrigger interval
    manufacturerId: 0x115f
  },
  aqaraSensitivityLevel : {
    id: 268, //0x010C
    type : ZCLDataTypes.uint8, // Aquara P1 motion sensor sensitivity level
    manufacturerId: 0x115f
  },
  aqaraMotionAndIllumination : {
    id: 274, //0x0112
    type : ZCLDataTypes.uint16, // Aquara P1 motion sensor illumination value
    manufacturerId: 0x115f
  },
  aqaraRemoteMode: {
    id: 293, // 0x0125
  ...
  aqaraMotionLed: { // Aqara P1 motion sensor motion led trigger indication
    id: 338, // 0x0152
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  ...
  aqaraCurtainTiltSupport: {
    id: 1026, // 0x0402
    type: ZCLDataTypes.bool,
    manufacturerId: 0x115f,
  },
  aqaraCurtainOperatingSpeed: {
    id: 1032, // 0x0408
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
