...
class ZigBeeDevice extends MeshDevice {
	...
	_mergeSystemAndUserOpts(capabilityId, clusterId, userOpts) {
		...
		try {
			systemOpts = Homey.util.recursiveDeepCopy(require(`./system/capabilities/${tempCapabilityId}/${clusterId}.js`));
			...
			if (err.code !== 'MODULE_NOT_FOUND' || err.message.indexOf(`/system/capabilities/${tempCapabilityId}/${clusterId}.js`) < 0) {
				process.nextTick(() => {
					throw err;
				});
			}
